...
uk_laws = [
    # Общая часть (статьи 1-5)
    {"article": "1", "title": "Уголовное законодательство", "penalty": "УК состоит из настоящего Кодекса. Новые законы подлежат включению в Кодекс", "stars": "📖", "note": ""},
    {"article": "1.2", "title": "Задачи Уголовного кодекса", "penalty": "Охрана прав и свобод, собственности, общественного порядка, предупреждение преступлений", "stars": "📖", "note": ""},
    {"article": "1.3", "title": "Принцип законности", "penalty": "Преступность деяния определяется только УК. Применение закона по аналогии не допускается", "stars": "📖", "note": ""},
    {"article": "1.4", "title": "Принцип равенства граждан перед законом", "penalty": "Все равны независимо от пола, расы, национальности, имущественного положения и т.д.", "stars": "📖", "note": ""},
    {"article": "1.5", "title": "Принцип вины", "penalty": "Ответственность только за виновные действия. Объективное вменение запрещено", "stars": "📖", "note": ""},
    {"article": "1.6", "title": "Принцип справедливости", "penalty": "Наказание должно соответствовать характеру и степени общественной опасности", "stars": "📖", "note": ""},
    {"article": "1.7", "title": "Принцип гуманизма", "penalty": "Наказание не может иметь целью причинение физических страданий", "stars": "📖", "note": ""},
    ...
    {"article": "1.10", "title": "Судимость", "penalty": "Правовой статус лица, осуждённого за преступление. Запрещает госслужбу", "stars": "📖", "note": ""},
    {"article": "1.11", "title": "Действие уголовного закона во времени", "penalty": "Преступность деяния определяется законом, действовавшим во время совершения", "stars": "📖", "note": ""},
    ...
    {"article": "2.6", "title": "Невиновное причинение вреда", "penalty": "Лицо не осознавало и не могло осознавать опасности своих действий", "stars": "📖", "note": ""},
    {"article": "3", "title": "Оконченное и неоконченное преступление", "penalty": "Приготовление, покушение, оконченное преступление", "stars": "📖", "note": ""},
    {"article": "3.2", "title": "Приготовление и покушение", "penalty": "Создание условий или действия, не доведённые до конца по независящим причинам", "stars": "📖", "note": ""},
    {"article": "3.3", "title": "Добровольный отказ от преступления", "penalty": "Прекращение приготовления или действий, если лицо осознавало возможность доведения", "stars": "📖", "note": ""},
    ...
    {"article": "3.7", "title": "Группа лиц, ОПГ, преступное сообщество", "penalty": "Совершение преступления группой лиц по предварительному сговору или организованной группой", "stars": "📖", "note": ""},
    {"article": "4", "title": "Необходимая оборона", "penalty": "Защита от посягательства, опасного для жизни. Не является преступлением", "stars": "📖", "note": ""},
    ...
    {"article": "4.4", "title": "Обоснованный риск", "penalty": "Достижение общественно полезной цели, если риск не сопряжён с угрозой жизни многих людей", "stars": "📖", "note": ""},
    {"article": "4.5", "title": "Исполнение приказа", "penalty": "Не является преступлением. Ответственность несёт отдавший незаконный приказ", "stars": "📖", "note": ""},
    {"article": "5", "title": "Виды наказаний", "penalty": "Штраф, лишение прав, увольнение, лишение свободы, принудительные работы", "stars": "📖", "note": ""},
    {"article": "5.3", "title": "Общие начала назначения наказания", "penalty": "Учитываются характер и степень опасности, личность виновного, смягчающие и отягчающие обстоятельства", "stars": "📖", "note": ""},
    {"article": "5.5", "title": "Смягчающие обстоятельства", "penalty": "Явка с повинной, примирение, помощь потерпевшему, зависимость и т.д.", "stars": "📖", "note": ""},
    {"article": "5.6", "title": "Отягчающие обстоятельства", "penalty": "Группа лиц, особая жестокость, использование доверия, рецидив и т.д.", "stars": "📖", "note": ""},
    {"article": "5.7", "title": "Назначение более мягкого наказания", "penalty": "При исключительных обстоятельствах", "stars": "📖", "note": ""},
    {"article": "5.8", "title": "Освобождение от уголовной ответственности", "penalty": "Примирение сторон, назначение судебного штрафа", "stars": "📖", "note": ""},
    {"article": "5.9", "title": "Сроки давности", "penalty": "15 дней (в игре). Боло-розыск: от ★ до ★★★★★", "stars": "📖", "note": ""},
    ...
    {"article": "5.12", "title": "Залог", "penalty": "$25.000 за 1 год лишения свободы", "stars": "📖", "note": ""},
    # Особенная часть — Глава VI
...
pk_laws = [
    ...
    {"article": "4", "title": "Неприкосновенность жилища", "penalty": "Осмотр — с согласия. Обыск — с ордером или в исключительных случаях с уведомлением прокурора в 1 час", "stars": "📜", "note": ""},
    ...
    {"article": "7", "title": "Свобода оценки доказательств", "penalty": "Судья оценивает по внутреннему убеждению. Исключение: боло-розыск", "stars": "📜", "note": ""},
    {"article": "8", "title": "Охрана прав и свобод", "penalty": "Обязаны разъяснять права, обеспечивать безопасность участников", "stars": "📜", "note": ""},
    {"article": "9", "title": "Право на обжалование", "penalty": "48 часов с момента задержания или вынесения наказания", "stars": "📜", "note": ""},
    ...
    {"article": "15", "title": "Задержание", "penalty": "Срок до 1 часа. Мера кратковременного лишения свободы", "stars": "⏰", "note": ""},
    ...
    {"article": "21", "title": "Исполнение штрафных санкций", "penalty": "Оплатить или сопроводить к банкомату", "stars": "💰", "note": ""},
    ...
    {"article": "29", "title": "Обыск транспорта", "penalty": "Обыск только с ордером. Осмотр — при ориентировке или подозрении", "stars": "🚗", "note": ""},
    ...
    {"article": "34", "title": "Компетенция", "penalty": "Действия вне компетенции запрещены", "stars": "📋", "note": ""},
    {"article": "35", "title": "Компетенция ведомств", "penalty": "Региональная, федеральная, финансовая, военная", "stars": "📋", "note": ""},
    {"article": "36", "title": "Стадии применения силы", "penalty": "1. Присутствие 2. Приказ 3. Физ. сила 4. Спецсредства 5. Огнестрельное оружие", "stars": "💪", "note": ""},
    {"article": "37", "title": "Розыск", "penalty": "Боло-розыск (автоматический), процессуальный, федеральный", "stars": "🔍", "note": ""},
    {"article": "39", "title": "Юридическая реабилитация", "penalty": "$120.000", "stars": "💰", "note": ""},
    {"article": "40", "title": "Ходатайства", "penalty": "Подозреваемый, обвиняемый, защитник, потерпевший", "stars": "📋", "note": ""},
    {"article": "43", "title": "Обжалование", "penalty": "Действия и решения следователя, прокурора, суда", "stars": "📋", "note": ""},
    {"article": "45", "title": "Следствие", "penalty": "Комплекс мер по выяснению обстоятельств", "stars": "🔍", "note": ""},
    {"article": "50", "title": "Следственные действия", "penalty": "Допрос, осмотр, обыск, выемка, очная ставка, опознание, экспертиза", "stars": "📋", "note": ""},
    {"article": "56", "title": "Допрос", "penalty": "Не более 1 часа. Адвокат присутствует, может потребовать 5-минутный перерыв", "stars": "👨‍⚖️", "note": ""},
    {"article": "72", "title": "Основания прекращения дела", "penalty": "Отсутствие события или состава, истечение сроков давности", "stars": "📋", "note": ""},
    {"article": "78", "title": "Терминология", "penalty": "Алиби, апелляция, вердикт, жилище, задержание, обыск, приговор", "stars": "📚", "note": ""},
...
async def ask_ai(question: str) -> str:
    try:
        uk_context = "\n".join([f"Ст.{l['article']}: {l['title']}" for l in uk_laws[:30]])
        pk_context = "\n".join([f"Ст.{p['article']}: {p['title']}" for p in pk_laws[:15]])
